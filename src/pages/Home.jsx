...
const HomePage = () => {
  ...
  return (
    ...
    //         <span className="absolute px-2 py-1 mt-2 text-xs text-white transition-opacity duration-300 transform -translate-x-1/2 bg-orange-500 rounded opacity-0 bg-opacity-20 left-1/2 group-hover:opacity-100">
    //           Home
    //         </span>
    //       </div>
    //       <div className="relative group">
    ...
    //             </svg>
    //             <svg
    //               className="absolute -rotate-32 w-80 -left-48 top-40"
    //               xmlns="http://www.w3.org/2000/svg"
    //               viewBox="0 0 252 151"
    //             >
    //               <path
    ...
    //               />
    //             </div>
    //             <h2 className="mt-12 mb-2 text-3xl font-bold text-center">
    //               Ayodhya Ratnayake
    //             </h2>
    ...
    //         <div className="mb-12">
    //           <h1 className="mt-8 -mb-1 text-5xl font-bold text-center sm:-mt-1 md:text-left lg:text-7xl md:text-5xl">
    //             SOFTWARE
    //           </h1>
    //           {/* <div className="text-sm sm:text-lg">Small text on mobile, large text on larger screens</div> */}

    //           <h2 className="mb-6 text-5xl font-bold text-center text-gray-600 md:text-left lg:text-7xl md:text-5xl">
    //             ENGINEER
    //           </h2>
    ...
    //               <div key={index}>
    //                 <div className="mb-1 text-5xl font-bold text-center">
    //                   {stat.value}
    //                 </div>
    ...
    //           </div> */}
    //           <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
    //             <div className="relative p-6 overflow-hidden text-white bg-orange-500 rounded-2xl">
    //               <svg
    //                 xmlns="http://www.w3.org/2000/svg"
    //                 fill="none"
    //                 viewBox="0 0 24 24"
    ...
    //                   DYNAMIC ANIMATION,
    //                 </div>
    //                 <div className="text-2xl font-semibold">MOTION DESIGN</div>
    //               </div>
    ...
    //         <div className="mb-16">
    //           <h3 className="mb-6 text-2xl font-bold">
    //             12 YEARS OF <span className="text-gray-600">EXPERIENCE</span>
    //           </h3>
    ...
    //           <h3 className="mb-8 text-4xl font-bold text-gray-600">
    //             THOUGHTS
    //           </h3>
